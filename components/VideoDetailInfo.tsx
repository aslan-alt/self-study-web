...
import {Image as ImageType} from '@/DB/entity';
import {TitleInput} from '@/components/TitleInput';
import {UploadInput} from '@/components/UploadInput';
import {uploadImage} from '../requests/uploadImage';

export type VideoNameAndDescribe = {
  name?: string;
  description?: string;
};
...
type Props = {
  ...
  setVideoTitleAndDescribe: React.Dispatch<React.SetStateAction<VideoNameAndDescribe>>;
};

export const VideoDetailInfo: FC<Props> = ({videoNameAndDescribe, setVideoTitleAndDescribe}) => {
  ...
  return (
    <div>
      ...
      <TitleInput
        ...
        value={videoNameAndDescribe?.name?.replace('.mp4', '')}
        onChange={(e) => {
          setVideoTitleAndDescribe((videoInfo) => ({
            ...videoInfo,
            name: `${e.target.value}.mp4`,
          }));
        }}
